...
namespace WindowsFormsApp1
{
    ...
    public partial class log_in : Form
    {
        ...
        private void button_Enter_Click(object sender, EventArgs e)
        {
            ...
            string queryString = $"select id, login, password FROM Admins " +
            ...
            {
                history += $" values ('-1', '{DateTime.Now.ToString("yyyy-dd-MM HH:mm:ss")}', 'false')";
            }
            else
            {
                history += $" values ({table.Rows[0].ItemArray[0]}, '{DateTime.Now.ToString("yyyy-dd-MM HH:mm:ss")}', 'true')";
            }
